					...
					<Row>
						<Col xs={12} sm={12} md={12} lg={8}>
							<Row>
								...
								<Col xs={12} sm={9} md={5} lg={7} xl={5} className='inputCurrency mt-2 mt-sm-0'>
									<InputCurrency
										listCurrency={listCurrency}
										onCurrencyChange={this.handleCurrencyInputChange}
										options={{ value: this.state.optionsInput.value, label: this.state.optionsInput.label }}
									/>
								</Col>
							</Row>
							...
							<Row className='mt-sm-3'>
								...
								<Col xs={12} sm={9} md={5} lg={7} xl={5} className='inputCurrency mt-2 mt-sm-0'>
									<InputCurrency
										listCurrency={listCurrency}
										onCurrencyChange={this.handleCurrencyOutputChange}
										options={{ value: this.state.optionsOutput.value, label: this.state.optionsOutput.label }}
									/>
								</Col>
							</Row>
							...
							<Row className='justify-content-center text-center mt-2 mt-md-5'>
								<Col>
									{this.state.inputCurrency && this.state.outputCurrency && this.state.isHistoryLoaded && (
										<CurrencyGraph
											graphValues={this.state.graphValues}
											graphLegend={this.state.graphLegend}
